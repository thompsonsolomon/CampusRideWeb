    ...
    return (
        ...
        <header className="fixed bottom-0 left-0 w-full right-0   z-50">
            ...
            <nav className="flex justify-around w-[90%] h-[7dvh] rounded-full bg-[#333333] items-center py-2">
                <Link
                    to={`/`}
                    className={`flex flex-col items-center bg-yellow-${path == "/" ? "500" : "100"}   p-4 rounded-full transition`}
                >
                    <img src={HomeIcon} alt="homeIcon" className="w-9 h-9" />
                </Link>
                ...
                >
                    <img src={History} alt="homeIcon" className="w-9 h-9" />
                </Link>
                ...
                >
                    <img src={ChatIcon} alt="homeIcon" className="w-9 h-9" />
                </Link>
                ...
                >
                    <img src={ProfileIcon} alt="homeIcon" className="w-9 h-9" />
                </Link>
            </nav>
            </div>
